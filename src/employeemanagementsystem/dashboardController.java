...
public class dashboardController implements Initializable {
	...
	public void homeTotalInactive() {
		...
		String sql = "SELECT COUNT(employee_id) FROM employee WHERE salary = '0.0'";
	...
	public void addEmployeeAdd() {
		...
		String sql = "INSERT INTO employee " + "(employee_id,firstName,lastName,gender,phoneNum,position,image,date) "
				+ "VALUES(?,?,?,?,?,?,?,?)";
		...
		try {
			Alert alert;
			if (addEmployee_employeeID.getText().isEmpty() || addEmployee_firstName.getText().isEmpty()
					...
					|| addEmployee_position.getSelectionModel().getSelectedItem() == null || getData.path == null
					|| getData.path == "") {
	...
	public void addEmployeeUpdate() {
		...
		String sql = "UPDATE employee SET firstName = '" + addEmployee_firstName.getText() + "', lastName = '"
				...
				+ addEmployee_position.getSelectionModel().getSelectedItem() + "', image = '" + uri + "', date = '"
				+ sqlDate + "' WHERE employee_id ='" + addEmployee_employeeID.getText() + "'";
		...
		try {
			...
			if (addEmployee_employeeID.getText().isEmpty() || addEmployee_firstName.getText().isEmpty()
				...
				if (option.get().equals(ButtonType.OK)) {
					...
					String checkData = "SELECT * FROM employee WHERE employee_id = '" + addEmployee_employeeID.getText()
							+ "'";
					...
					String updateInfo = "UPDATE employee SET firstName = '" + addEmployee_firstName.getText()
	...
	public void salaryUpdate() {
		...
		String sql = "UPDATE employee SET salary = '" + salary_salary.getText() + "' WHERE employee_id = '"
